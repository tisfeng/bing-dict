...
exports.parsePhrase = exports.parseForms = exports.parseExplains = exports.parseAudioUrl = exports.parsePhonetic = exports.parseParaphrase = void 0;
    ...
    axios_1.default.get(queryWordUrl).then((response) => {
        ...
        if (audioUrl) {
            ...
            (0, audio_1.downloadWordAudio)(audioUrl, audioPath, () => {
                ...
                sound_play_1.default.play(audioPath);
            });
        }
    });
}
