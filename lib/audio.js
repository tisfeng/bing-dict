...
exports.getWordAudioPath =
  exports.downloadWordAudio =
  exports.playAudio =
    void 0;
...
const audioDirPath = path_1.default.resolve(__dirname, "../audio");
...
function playAudio(audioPath) {
  ...
  (0, child_process_1.execFile)("afplay", [audioPath], (error, stdout) => {
    if (error) {
...
function downloadWordAudio(url, audioPath, callback) {
  ...
  (0, axios_1.default)({
    ...
    .then((response) => {
      response.data.pipe(
        fs_1.default.createWriteStream(audioPath).on(
          "close",
          callback
            ? callback
            : () => {
